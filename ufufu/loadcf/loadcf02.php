<?php if(get_field('商品01', 10)): ?>
	<?php if( get_field('商品01', 10)['写真']){ $imgid = get_field('商品01', 10)['写真'];$img = wp_get_attachment_image_src( $imgid , 'full' ); ?>
	...
	<?php } ?>
	<p class="text"><?php echo get_field('商品01', 10)['商品名'] ?></p>
	<p class="price">¥<?php echo get_field('商品01', 10)['価格'] ?></p>
<?php endif; ?>
